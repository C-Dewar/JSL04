...
console.log(userPreference.trim().toLowerCase() === "sugar-free"? 'Sugar-free': 'Regular');

/*the above use of the trim and toLowerCase functions, ensure that the user input can be slightly off in terms of capitalisation or spacing, 
but still have the appropriate syntax output.*/ 
